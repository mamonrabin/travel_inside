...
const BookingSection = () => {
  return (
    <div className="lg:mt-30 sticky top-5">
      <div className="border rounded">
        <h2 className="py-2 xl:px-8 px-4 bg-[#55BEEF] rounded-t flex items-center gap-2 text-white font-medium">
          <MdLocalPhone />
          প্যাকেজের বিস্তারিত জানতে কল করুন
        </h2>

        <div className="xl:px-8 px-4 py-4 space-y-1 border-b-2 border-[#55BEEF] rounded-b">
